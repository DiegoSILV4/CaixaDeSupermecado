...
public class caixa_GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(300, 130, 90, 16);

        jLabel2.setText("Feijão = 25R$");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(300, 160, 90, 16);

        jLabel3.setText("Óleo = 10R$");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(300, 190, 80, 16);
        ...
        jPanel1.add(arroz);
        arroz.setBounds(390, 130, 25, 22);
        jPanel1.add(feijao);
        feijao.setBounds(390, 160, 25, 22);
        jPanel1.add(oleo);
        oleo.setBounds(390, 220, 24, 22);

        jLabel4.setText("Alho = 5R$");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(300, 220, 80, 16);
        ...
        jPanel1.add(alho);
        alho.setBounds(390, 190, 24, 22);

        buttonGroup2.add(cc);
        cc.setText("CARTÃO DE CRÉDITO");
        jPanel1.add(cc);
        cc.setBounds(450, 240, 170, 21);

        buttonGroup2.add(cd);
        cd.setText("CARTÃO DE DÉBITO");
        jPanel1.add(cd);
        cd.setBounds(450, 260, 170, 21);

        buttonGroup2.add(din);
        din.setText("DINHEIRO");
        jPanel1.add(din);
        din.setBounds(450, 280, 170, 21);

        buttonGroup2.add(pix);
        pix.setText("PIX");
        jPanel1.add(pix);
        pix.setBounds(450, 300, 170, 21);
        ...
        jButton1.setBounds(680, 0, 40, 20);
    ...
    private void calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcularActionPerformed
        ...
        double total_ol = ol_conv * 5;

        double total_produtos = ( total_arr + total_feij + total_al  + total_ol);
        JOptionPane.showMessageDialog(null,"Valor total da compra: " + "R$ "+total_produtos);
    ...
    private void PagamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PagamentoActionPerformed
        ...
        double total_produtos = (total_arr + total_feij + total_al + total_ol);
        int qntd = (arr_conv+feij_conv+al_conv+ol_conv);
        ...
        String sql = "INSERT INTO vendas(ven_horario, ven_preco, ven_qntd) values('"+timeString+"', '"+total_produtos+"','"+qntd+"')";
